...
**/
    ...
    public void ingestZipCode(String _zipCode) {
        ...
        //return marketid;
        FarmersMarketAPITranslator farmers = new FarmersMarketAPITranslator();
        ArrayList<MarketID> markets = farmers.loadMarketByZip(_zipCode);
        RTIUI.displayMarkets(markets);
