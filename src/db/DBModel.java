...
public class DBModel extends APIBase {
    ...
    public void fruitSearch() {
        ...
        System.out.println("Fruit have been searched.");
    }
    public void vegetableSearch() {
        // An item has been added to the ticket. Fire an event and let everyone know.
        System.out.println("Vegetables have been searched.");
    }
    @Override
